...
app = FastAPI(title="AlphaPilot", version="0.2.0")
...
app.include_router(binance.router, prefix="/api/binance", tags=["binance-relay"])
app.include_router(market.router, prefix="/api/market", tags=["market-analysis"])
app.include_router(positions.router, prefix="/api/positions", tags=["positions"])
app.include_router(agent.router, prefix="/api/agent", tags=["agent"])
app.include_router(agent_chat.router, prefix="/api/agent-chat", tags=["agent-chat"])
